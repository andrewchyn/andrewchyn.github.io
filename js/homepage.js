// If you are reading this code, I wan't to acknowledge that it is a mess.
// I've been working on implementing a combat system I came up with in Unity, 
// and will eventually change port it to my website. Until then, this crappy demo remains
...
class homepage extends Phaser.Scene{
    ...
    create(){
            ...
            r1 = this.add.image(100,100, "folder");
            r1.setScale(0.8)
            ...
            walls.create(250,140, "wall").setScale(0.15,1).refreshBody();
            walls.create(900,620, "wall").setScale(0.2).refreshBody();
            walls.create(600,520, "wall").setScale(0.2).refreshBody();
            walls.create(1200,670, "wall").setScale(0.2).refreshBody();
            // walls.create(400,400, "wall").setScale(0.2).refreshBody();

            // Breakables
            breakables = this.physics.add.staticGroup();
            //dbreakables.create(100,300, "black").setScale(1,0.2).refreshBody();
            ...
            // Player
            player = this.physics.add.sprite(config.width-100, config.height-100, "player");
